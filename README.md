...
Phải có file .env chứa thông tin Supabase trong thư mục backend.

Phải có file .env chứa thông tin Supabase trong thư mục frontend.

Việc chạy backend và frontend phải song song với nhau. Bạn cần mở 2 terminal: một cho python app.py (backend) và một cho npm run dev (frontend).
