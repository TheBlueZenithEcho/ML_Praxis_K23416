            ...
            <div className="container mx-auto px-4 border-b text-[#FDFBCE] pb-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="text-sm text-[#ffffff] mb-2"><i className="bi bi-geo-alt-fill mr-2 font-inter"></i>2443 Oak Ridge Omaha, GA 45065</p>
                        <p className="text-sm text-[#ffffff] mb-2"><i className="bi bi-telephone-fill mr-2 font-inter"></i>207-8767-452</p>
                        <p className="text-sm text-[#ffffff] mb-2"><i className="bi bi-telephone-fill mr-2 font-inter"></i>082-245-7233</p>
