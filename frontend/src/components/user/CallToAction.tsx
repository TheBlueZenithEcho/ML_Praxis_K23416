...
const CallToAction: FC = () => {
    // URL ảnh nền cho phần này
    const backgroundStyle = {
        backgroundImage: "url('your-camera-image.jpg')" // Thay bằng ảnh thật
    };

    return (
        <section className="relative h-96 my-16 bg-cover bg-center" style={backgroundStyle}>
            <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center text-white">
                ...
                <p className="text-lg mb-6">We Are Always Ready To Take A Perfect Shot</p>
